class bio:
    def __init__(self):
        ...
        self.lines_in_topo_ave = {'biosphere_kegg':2, \
                'ecosystem_YNP':2, 'ecosystem_JGI':2, \
    ...
    def species_name(self, system_name, species):
        inputfile = open('../data/bio/rxn_lists/%s/rxn_%s-%d.dat'\
                    %(system_name, system_name, species), 'r')
